...
CompileErrorScenarios == {"UC061_Error_OutputUnwritable", "UC062_Error_DirectoryEntryTooLarge", "UC063_Error_DirectoryTooLarge", "UC084_Error_WriterInputReadFailure", "UC085_Error_LockedOutputPreserved", "UC086_Error_MetadataEntryTooLarge", "UC094_Chm_InternalStreamCollision", "UC095_Error_OutputOverwriteRejected"}
...
ImplStderrTags == {"#SYSTEM entry is too large", "Directory entry is too large", "Unable to open", "add log", "directory is too large for this compiler version", "error", "input file read error", "internal stream collision", "output file locked", "output overwrite"}
...
ImplStdout(s) ==
  ...
  [] s = "UC007_Cli_MultipleProjects" -> {"Banner", "Options", "Usage"}
