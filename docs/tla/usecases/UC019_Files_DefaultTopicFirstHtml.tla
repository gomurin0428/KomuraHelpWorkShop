---- MODULE UC019_Files_DefaultTopicFirstHtml ----
EXTENDS Integers

(*
Scenario: first HTML file becomes default topic
...
ExpectedCollectionTags == {"DefaultTopicFirstHtml"}
ExpectedArchive == {"index.html", "readme.txt"}
ExpectedMetadata == {"DefaultTopic:index.html", "Output:project/help.chm"}
