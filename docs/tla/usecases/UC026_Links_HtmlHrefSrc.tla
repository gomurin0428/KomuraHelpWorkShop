---- MODULE UC026_Links_HtmlHrefSrc ----
EXTENDS Integers

(*
Scenario: HTML href and src links are recursively collected
...
ExpectedCollectionTags == {"HtmlLinks", "LinkScan"}
ExpectedArchive == {"images/logo.png", "index.html", "styles/site.css", "topics/intro.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "HtmlLinks" \in collectionTags
    /\ "topics/intro.html" \in archive
    /\ "styles/site.css" \in archive
