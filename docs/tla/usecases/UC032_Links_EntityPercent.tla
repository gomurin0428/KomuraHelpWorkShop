---- MODULE UC032_Links_EntityPercent ----
EXTENDS Integers

(*
Scenario: HTML entities and percent escapes are decoded
...
ExpectedCollectionTags == {"DecodeHtmlPercent", "LinkScan"}
ExpectedArchive == {"index.html", "topics/a b.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "DecodeHtmlPercent" \in collectionTags
    /\ "topics/a b.html" \in archive
