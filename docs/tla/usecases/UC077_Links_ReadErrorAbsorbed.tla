---- MODULE UC077_Links_ReadErrorAbsorbed ----
EXTENDS Integers

(*
Scenario: link scanner read failures are absorbed as no outgoing links
...
ExpectedCollectionTags == {"LinkReadFailed", "LinkScan"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "LinkReadFailed" \in collectionTags
    /\ archive = {"index.html"}
    /\ exitCode = 0
