---- MODULE UC016_Hhp_DuplicateOptionLastWins ----
EXTENDS Integers

(*
Scenario: last duplicate option value wins
...
ExpectedMetadata == {"Hhp:LastOptionWins", "Output:project/help.chm", "Title:New Title"}
