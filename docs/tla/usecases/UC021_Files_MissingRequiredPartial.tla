---- MODULE UC021_Files_MissingRequiredPartial ----
EXTENDS Integers

(*
Scenario: missing required file emits HHC5003 and a partial CHM
...
ExpectedCollectionTags == {"MissingRequired"}
ExpectedArchive == {}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "MissingRequired" \in collectionTags
    /\ archive = {}
    /\ "HHC5003" \in warnings
    /\ exitCode = 0
    /\ chmCreated = TRUE
