---- MODULE UC078_Encoding_InvalidUtf8Fallback ----
EXTENDS Integers

(*
Scenario: invalid UTF-8 without BOM falls back to the selected ANSI encoding
...
ExpectedCollectionTags == {"AnsiFallback", "InvalidUtf8Fallback"}
ExpectedArchive == {"index.html"}
ExpectedMetadata == {"Encoding:InvalidUtf8Fallback", "Output:project/help.chm", "TextEncoding:AnsiFallback"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "InvalidUtf8Fallback" \in collectionTags
    /\ "Encoding:InvalidUtf8Fallback" \in metadata
