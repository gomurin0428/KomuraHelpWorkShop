---- MODULE UC081_Metadata_FlatOptionArchivePaths ----
EXTENDS Integers

(*
Scenario: flat mode normalizes contents and index option archive paths
...
ExpectedMetadata == {"Contents:toc.hhc", "Index:index.hhk", "Output:project/help.chm"}
