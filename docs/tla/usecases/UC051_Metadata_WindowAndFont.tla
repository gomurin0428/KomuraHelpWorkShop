---- MODULE UC051_Metadata_WindowAndFont ----
EXTENDS Integers

(*
Scenario: custom window and font are reflected
...
ExpectedMetadata == {"Font:MS UI Gothic, 9", "Output:project/help.chm", "Window:custom"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Window:custom" \in metadata
    /\ "Font:MS UI Gothic, 9" \in metadata
