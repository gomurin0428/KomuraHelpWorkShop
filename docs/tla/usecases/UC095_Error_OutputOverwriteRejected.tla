---- MODULE UC095_Error_OutputOverwriteRejected ----
EXTENDS Integers

(*
Scenario: output paths that overwrite project or input files are rejected
...
ExpectedCollectionTags == {"CollectFailed", "OutputPathCollision"}
ExpectedArchive == {}
ExpectedMetadata == {}
ExpectedWriterTags == {"Skipped"}
ExpectedStdout == {}
ExpectedStderr == {"error", "output overwrite"}
ExpectedWarnings == {}
ExpectedExit == 1
...
UseCaseSpecificContract ==
  phase = "Done" =>
    ...
    /\ "OutputPathCollision" \in collectionTags
    /\ exitCode = 1
    /\ chmCreated = FALSE
