---- MODULE UC027_Links_CssImportUrl ----
EXTENDS Integers

(*
Scenario: CSS import and url links are collected
...
ExpectedCollectionTags == {"CssLinks", "LinkScan"}
ExpectedArchive == {"images/bg.png", "styles/site.css", "styles/theme.css"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "CssLinks" \in collectionTags
    /\ "styles/theme.css" \in archive
    /\ "images/bg.png" \in archive
