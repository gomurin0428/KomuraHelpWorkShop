---- MODULE UC018_Files_RequiredFiles ----
EXTENDS Integers

(*
Scenario: required HHP files are collected
...
ExpectedArchive == {"index.hhk", "index.html", "toc.hhc", "topics/start.html"}
ExpectedMetadata == {"DefaultTopic:topics/start.html", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "topics/start.html" \in archive
    /\ "DefaultTopic:topics/start.html" \in metadata
