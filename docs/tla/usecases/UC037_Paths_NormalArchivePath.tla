---- MODULE UC037_Paths_NormalArchivePath ----
EXTENDS Integers

(*
Scenario: normal mode preserves project-relative archive path
...
ExpectedCollectionTags == {"NormalizeArchivePath"}
ExpectedArchive == {"topics/usage.html"}
