---- MODULE UC006_Cli_MissingProjectArg ----
EXTENDS Integers

(*
Scenario: missing project path is an argument error
...
ExpectedCliMode == "ArgError"
ExpectedProjectState == "Skipped"
ExpectedCollectionTags == {"Skipped"}
ExpectedArchive == {}
ExpectedMetadata == {}
ExpectedWriterTags == {"Skipped"}
ExpectedStdout == {}
ExpectedStderr == {"missing .hhp project path"}
ExpectedWarnings == {}
ExpectedExit == 2
ExpectedChmCreated == FALSE
ExpectedVisited == {"CliParsed", "Done", "Start"}
