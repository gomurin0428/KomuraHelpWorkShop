---- MODULE UC075_Links_UncIgnored ----
EXTENDS Integers

(*
Scenario: network-share style links are ignored as non-local targets
...
ExpectedCollectionTags == {"UncLinkIgnored"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "UncLinkIgnored" \in collectionTags
    /\ archive = {"index.html"}
    /\ warnings = {}
