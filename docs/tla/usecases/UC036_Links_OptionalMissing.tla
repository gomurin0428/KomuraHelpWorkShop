---- MODULE UC036_Links_OptionalMissing ----
EXTENDS Integers

(*
Scenario: optional linked file absence warns but succeeds
...
ExpectedCollectionTags == {"LinkScan", "OptionalMissing"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "OptionalMissing" \in collectionTags
    /\ "file not found" \in warnings
    /\ exitCode = 0
