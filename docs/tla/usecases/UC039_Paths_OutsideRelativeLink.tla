---- MODULE UC039_Paths_OutsideRelativeLink ----
EXTENDS Integers

(*
Scenario: outside relative links use archive base directory
...
ExpectedCollectionTags == {"ArchiveBaseDirectory", "LinkScan"}
ExpectedArchive == {"shared/page.html", "topics/intro.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "ArchiveBaseDirectory" \in collectionTags
    /\ "shared/page.html" \in archive
