---- MODULE UC058_Unsupported_BinaryIndex ----
EXTENDS Integers

(*
Scenario: Binary Index warns and embeds HHK source
...
ExpectedCollectionTags == {"SourceIndexEmbedded", "UnsupportedWarning"}
ExpectedArchive == {"index.hhk"}
...
ExpectedStderr == {}
ExpectedWarnings == {"Binary Index is not implemented"}
ExpectedExit == 0
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "SourceIndexEmbedded" \in collectionTags
    /\ "index.hhk" \in archive
    /\ "Binary Index is not implemented" \in warnings
