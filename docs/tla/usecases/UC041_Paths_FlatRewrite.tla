---- MODULE UC041_Paths_FlatRewrite ----
EXTENDS Integers

(*
Scenario: Flat mode rewrites local references
Implementation slices reflected: CliOptions.Parse, HhpProject.Load, ProjectCompiler.CollectFiles, ArchivePath.NormalizeForArchive, LinkScanner.RewriteLinksForFlatArchive, ChmWriter.Write
...
ExpectedCollectionTags == {"Flat", "FlatRewrite", "LinkScan"}
ExpectedArchive == {"bg.png", "index.html", "logo.png", "site.css", "toc.hhc", "usage.html"}
ExpectedMetadata == {"LinksRewrittenForFlat:true", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "FlatRewrite" \in collectionTags
    /\ "LinksRewrittenForFlat:true" \in metadata
    /\ "logo.png" \in archive
