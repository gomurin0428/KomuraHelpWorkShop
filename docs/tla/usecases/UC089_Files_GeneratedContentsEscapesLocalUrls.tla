---- MODULE UC089_Files_GeneratedContentsEscapesLocalUrls ----
EXTENDS Integers

(*
Scenario: generated contents escapes URL-reserved Local values
...
ExpectedCollectionTags == {"GeneratedContents", "GeneratedContentsLocalUrlEscaped"}
ExpectedArchive == {"C#Guide.html", "Table of Contents.hhc", "literal%23.html"}
ExpectedMetadata == {"Contents:Table of Contents.hhc", "ContentsGenerated:true", "GeneratedContentsLocalUrlEscaped:true", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "GeneratedContentsLocalUrlEscaped" \in collectionTags
    /\ "GeneratedContentsLocalUrlEscaped:true" \in metadata
