---- MODULE UC070_Hhp_TruthyFlatOn ----
EXTENDS Integers

(*
Scenario: truthy Flat option values enable flat archive mode
...
ExpectedCollectionTags == {"Flat", "FlatArchive", "TruthyOption"}
ExpectedArchive == {"help.css", "usage.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "TruthyOption" \in collectionTags
    /\ "usage.html" \in archive
    /\ "help.css" \in archive
