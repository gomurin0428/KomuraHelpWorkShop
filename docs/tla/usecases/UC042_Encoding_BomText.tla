---- MODULE UC042_Encoding_BomText ----
EXTENDS Integers

(*
Scenario: BOM text files are read by BOM
...
ExpectedCollectionTags == {"BomDetected"}
ExpectedArchive == {"index.html"}
ExpectedMetadata == {"Encoding:BOM", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "BomDetected" \in collectionTags
    /\ "Encoding:BOM" \in metadata
