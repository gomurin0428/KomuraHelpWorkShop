---- MODULE UC010_Hhp_OutAbsoluteOverride ----
EXTENDS Integers

(*
Scenario: absolute -o output is not rebased
...
ExpectedMetadata == {"Output:absolute/output.chm", "Title:Project Title"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Output:absolute/output.chm" \in metadata
