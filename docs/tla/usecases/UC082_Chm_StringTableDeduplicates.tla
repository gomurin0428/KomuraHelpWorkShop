---- MODULE UC082_Chm_StringTableDeduplicates ----
EXTENDS Integers

(*
Scenario: CHM string table reuses duplicate metadata strings
...
ExpectedMetadata == {"Output:project/help.chm", "StringTable:Deduplicated", "Title:Project Title", "Window:main"}
ExpectedWriterTags == {"InternalStreams", "PMGL", "StringTableDeduplicated", "Uncompressed"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "StringTable:Deduplicated" \in metadata
