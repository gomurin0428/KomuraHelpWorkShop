---- MODULE UC038_Paths_NormalizeDots ----
EXTENDS Integers

(*
Scenario: path separators and dot segments are normalized
...
ExpectedCollectionTags == {"NormalizeDots"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "NormalizeDots" \in collectionTags
    /\ archive = {"index.html"}
