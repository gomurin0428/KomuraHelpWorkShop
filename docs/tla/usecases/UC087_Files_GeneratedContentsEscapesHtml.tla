---- MODULE UC087_Files_GeneratedContentsEscapesHtml ----
EXTENDS Integers

(*
Scenario: generated contents escapes HTML-sensitive topic names
...
ExpectedCollectionTags == {"GeneratedContents", "GeneratedContentsEscaped"}
ExpectedArchive == {"Table of Contents.hhc", "topic-&-one.html"}
ExpectedMetadata == {"Contents:Table of Contents.hhc", "ContentsGenerated:true", "GeneratedContentsEscaped:true", "Output:project/help.chm"}
ExpectedWriterTags == {"InternalStreams", "PMGL", "Uncompressed"}
ExpectedStdout == {"Banner", "Compiled", "Files"}
ExpectedStderr == {}
ExpectedWarnings == {"generated toc"}
ExpectedExit == 0
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "GeneratedContentsEscaped" \in collectionTags
    /\ "GeneratedContentsEscaped:true" \in metadata
    /\ "topic-&-one.html" \in archive
