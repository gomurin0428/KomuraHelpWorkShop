---- MODULE UC035_Links_NonScannable ----
EXTENDS Integers

(*
Scenario: non-scannable files do not produce links
...
ExpectedCollectionTags == {"NonScannable"}
ExpectedArchive == {"downloads/manual.pdf"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "NonScannable" \in collectionTags
    /\ archive = {"downloads/manual.pdf"}
