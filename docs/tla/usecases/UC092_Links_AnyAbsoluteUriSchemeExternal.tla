---- MODULE UC092_Links_AnyAbsoluteUriSchemeExternal ----
EXTENDS Integers

(*
Scenario: all absolute URI schemes are treated as external links
...
ExpectedCollectionTags == {"AllAbsoluteSchemesExternal", "ExternalLinksIgnored"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "AllAbsoluteSchemesExternal" \in collectionTags
    /\ archive = {"index.html"}
    /\ warnings = {}
