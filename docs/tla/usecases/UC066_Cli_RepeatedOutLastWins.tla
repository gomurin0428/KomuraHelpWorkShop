---- MODULE UC066_Cli_RepeatedOutLastWins ----
EXTENDS Integers

(*
Scenario: repeated output option uses the last value
...
ExpectedMetadata == {"Hhp:LastOptionWins", "Output:project/final.chm", "Title:Project Title"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Output:project/final.chm" \in metadata
    /\ "Hhp:LastOptionWins" \in metadata
