---- MODULE UC084_Error_WriterInputReadFailure ----
EXTENDS Integers

(*
Scenario: writer input file read failure exits without creating CHM
...
ExpectedWriterTags == {"InputReadError", "WriteFailed"}
ExpectedStdout == {}
