---- MODULE UC074_Links_EmptyAndFragmentIgnored ----
EXTENDS Integers

(*
Scenario: empty and fragment-only links are ignored without warnings
...
ExpectedCollectionTags == {"EmptyLinkIgnored", "LinkScan"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "EmptyLinkIgnored" \in collectionTags
    /\ archive = {"index.html"}
    /\ warnings = {}
