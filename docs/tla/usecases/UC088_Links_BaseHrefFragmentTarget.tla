---- MODULE UC088_Links_BaseHrefFragmentTarget ----
EXTENDS Integers

(*
Scenario: fragment-only links resolve against local base href
...
ExpectedCollectionTags == {"BaseFragment", "LinkScan", "RelativeBase"}
ExpectedArchive == {"index.html", "topics/chapter.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "BaseFragment" \in collectionTags
    /\ "topics/chapter.html" \in archive
