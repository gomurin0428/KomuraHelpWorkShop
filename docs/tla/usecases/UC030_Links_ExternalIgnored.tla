---- MODULE UC030_Links_ExternalIgnored ----
EXTENDS Integers

(*
Scenario: external and CHM links are ignored
...
ExpectedCollectionTags == {"ExternalLinksIgnored"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "ExternalLinksIgnored" \in collectionTags
    /\ archive = {"index.html"}
    /\ warnings = {}
