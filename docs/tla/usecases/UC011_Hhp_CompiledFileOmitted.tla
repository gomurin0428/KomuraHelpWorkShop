---- MODULE UC011_Hhp_CompiledFileOmitted ----
EXTENDS Integers

(*
Scenario: omitted compiled file uses project stem
...
ExpectedMetadata == {"Output:project/manual.chm", "Title:manual"}
