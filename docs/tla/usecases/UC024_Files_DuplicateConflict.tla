...
(*
Scenario: conflicting duplicate archive path silently keeps last file
...
ExpectedMetadata == {"KeptSource:b/index.html", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    ...
    /\ "KeptSource:b/index.html" \in metadata
    /\ warnings = {}
