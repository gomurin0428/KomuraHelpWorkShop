---- MODULE UC024_Files_DuplicateConflict ----
EXTENDS Integers

(*
Scenario: conflicting duplicate archive path keeps first file
...
ExpectedCollectionTags == {"DuplicateConflict", "Flat"}
ExpectedArchive == {"index.html"}
ExpectedMetadata == {"KeptSource:a/index.html", "Output:project/help.chm"}
ExpectedWriterTags == {"InternalStreams", "PMGL", "Uncompressed"}
ExpectedStdout == {"Banner", "Compiled", "Files"}
ExpectedStderr == {}
ExpectedWarnings == {"duplicate archive path"}
ExpectedExit == 0
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "DuplicateConflict" \in collectionTags
    /\ "KeptSource:a/index.html" \in metadata
    /\ "duplicate archive path" \in warnings
