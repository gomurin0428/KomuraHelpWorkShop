---- MODULE UC048_Metadata_CoreFields ----
EXTENDS Integers

(*
Scenario: core metadata fields are reflected
...
ExpectedCollectionTags == {"RequiredFiles"}
ExpectedArchive == {"index.hhk", "index.html", "toc.hhc"}
ExpectedMetadata == {"Contents:toc.hhc", "DefaultTopic:index.html", "Index:index.hhk", "Output:project/help.chm", "Title:Product Help"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Title:Product Help" \in metadata
    /\ "Contents:toc.hhc" \in metadata
    /\ "Index:index.hhk" \in metadata
