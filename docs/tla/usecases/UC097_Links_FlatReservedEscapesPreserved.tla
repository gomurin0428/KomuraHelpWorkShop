---- MODULE UC097_Links_FlatReservedEscapesPreserved ----
EXTENDS Integers

(*
Scenario: flat archives preserve payload links with reserved filename escapes
Implementation slices reflected: CliOptions.Parse, HhpProject.Load, ProjectCompiler.CollectFiles, ArchivePath.NormalizeForArchive, LinkScanner.ExtractLinks, ChmWriter.Write
...
ExpectedCollectionTags == {"Flat", "FlatRewrite", "ReservedEscapePreserved"}
ExpectedArchive == {"C#Guide.html", "index.html"}
ExpectedMetadata == {"Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "ReservedEscapePreserved" \in collectionTags
    /\ "C#Guide.html" \in archive
