---- MODULE UC071_Files_DotPathIgnored ----
EXTENDS Integers

(*
Scenario: project paths that normalize to an empty archive path are skipped
...
ExpectedCollectionTags == {"DotPathIgnored", "GeneratedContents"}
ExpectedArchive == {"Table of Contents.hhc"}
ExpectedMetadata == {"Contents:Table of Contents.hhc", "ContentsGenerated:true", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "DotPathIgnored" \in collectionTags
    /\ archive = {"Table of Contents.hhc"}
    /\ "generated toc" \in warnings
