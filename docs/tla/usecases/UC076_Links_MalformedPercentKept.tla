---- MODULE UC076_Links_MalformedPercentKept ----
EXTENDS Integers
...
ExpectedCollectionTags == {"LinkScan", "MalformedPercentKept"}
ExpectedArchive == {"bad%ZZ.html", "index.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "MalformedPercentKept" \in collectionTags
    /\ "bad%ZZ.html" \in archive
