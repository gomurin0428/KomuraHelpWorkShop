---- MODULE UC050_Metadata_DefaultWindowMain ----
EXTENDS Integers

(*
Scenario: omitted default window uses main
...
ExpectedMetadata == {"Output:project/help.chm", "Window:main"}
