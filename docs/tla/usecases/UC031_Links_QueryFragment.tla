---- MODULE UC031_Links_QueryFragment ----
EXTENDS Integers

(*
Scenario: query and fragment are stripped for collection
...
ExpectedCollectionTags == {"CleanQueryFragment", "LinkScan"}
ExpectedArchive == {"index.html", "topics/usage.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "CleanQueryFragment" \in collectionTags
