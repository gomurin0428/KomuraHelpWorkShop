---- MODULE UC012_Hhp_ProjectMissing ----
EXTENDS Integers

(*
Scenario: missing HHP fails before collection
Implementation slices reflected: CliOptions.Parse, HhpProject.Load, Program.Main
...
ExpectedProjectState == "Missing"
ExpectedCollectionTags == {"Skipped"}
ExpectedArchive == {}
ExpectedMetadata == {}
ExpectedWriterTags == {"Skipped"}
ExpectedStdout == {}
ExpectedStderr == {"Project file not found"}
ExpectedWarnings == {}
ExpectedExit == 1
ExpectedChmCreated == FALSE
ExpectedVisited == {"CliParsed", "Done", "ProjectMissing", "Start"}
