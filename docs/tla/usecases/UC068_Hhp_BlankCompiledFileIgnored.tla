---- MODULE UC068_Hhp_BlankCompiledFileIgnored ----
EXTENDS Integers

(*
Scenario: blank compiled file option falls back to project stem
...
ExpectedMetadata == {"Hhp:BlankOptionIgnored", "Output:project/manual.chm", "Title:manual"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Hhp:BlankOptionIgnored" \in metadata
    /\ "Output:project/manual.chm" \in metadata
