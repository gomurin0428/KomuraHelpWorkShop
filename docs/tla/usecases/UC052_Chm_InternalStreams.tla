---- MODULE UC052_Chm_InternalStreams ----
EXTENDS Integers

(*
Scenario: CHM internal streams are present
...
ExpectedWriterTags == {"InternalStreams", "Itbits", "NameList", "PMGL", "Strings", "System", "Uncompressed", "Windows"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "NameList" \in writerTags
    /\ "System" \in writerTags
    /\ "Windows" \in writerTags
    /\ "Strings" \in writerTags
    /\ "Itbits" \in writerTags
