---- MODULE UC087_Files_OmittedContentsKeepsHtmlTopic ----
EXTENDS Integers

(*
Scenario: omitted contents does not synthesize an escaped TOC
...
ExpectedArchive == {"topic-&-one.html"}
ExpectedMetadata == {"DefaultTopic:topic-&-one.html", "Output:project/help.chm"}
