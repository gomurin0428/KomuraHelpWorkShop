---- MODULE UC072_Files_AbsoluteProjectFileNameOnly ----
EXTENDS Integers

(*
Scenario: rooted project file outside the project stores the file name
...
ExpectedCollectionTags == {"AbsoluteProjectFile"}
ExpectedArchive == {"asset.bin"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "AbsoluteProjectFile" \in collectionTags
    /\ archive = {"asset.bin"}
