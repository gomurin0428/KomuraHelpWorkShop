---- MODULE UC008_Hhp_StandardCompile ----
EXTENDS Integers

(*
Scenario: standard HHP compile
...
ExpectedArchive == {"index.hhk", "index.html", "toc.hhc", "topics/intro.html"}
ExpectedMetadata == {"Contents:toc.hhc", "DefaultTopic:index.html", "Index:index.hhk", "Output:project/help.chm", "Title:Project Title"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    ...
    /\ "toc.hhc" \in archive
    /\ "DefaultTopic:index.html" \in metadata
