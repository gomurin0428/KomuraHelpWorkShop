---- MODULE UC047_Encoding_DbcsLanguages ----
EXTENDS Integers

(*
Scenario: DBCS languages set the DBCS system flag
...
ExpectedMetadata == {"DBCS:true", "Output:project/help.chm"}
