---- MODULE UC067_Cli_OutBeforeProject ----
EXTENDS Integers

(*
Scenario: output option before the project path is accepted
...
ExpectedMetadata == {"Output:project/dist/output.chm", "Title:Project Title"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Output:project/dist/output.chm" \in metadata
