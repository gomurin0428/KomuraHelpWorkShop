---- MODULE UC028_Links_LocalParam ----
EXTENDS Integers

(*
Scenario: HHC and HHK Local params are collected
Implementation slices reflected: CliOptions.Parse, HhpProject.Load, ProjectCompiler.CollectFiles, LinkScanner.ExtractLinks, ArchivePath.CleanLink, ChmWriter.Write
...
ExpectedCollectionTags == {"LinkScan", "LocalParamLinks"}
ExpectedArchive == {"index.hhk", "toc.hhc", "topics/reference.html", "topics/usage.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "LocalParamLinks" \in collectionTags
    /\ "topics/usage.html" \in archive
    /\ "topics/reference.html" \in archive
