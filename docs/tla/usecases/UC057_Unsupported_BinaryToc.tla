---- MODULE UC057_Unsupported_BinaryToc ----
EXTENDS Integers

(*
Scenario: Binary TOC warns and embeds HHC source
...
ExpectedCollectionTags == {"SourceTocEmbedded", "UnsupportedWarning"}
...
ExpectedStderr == {}
ExpectedWarnings == {"Binary TOC is not implemented"}
ExpectedExit == 0
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "SourceTocEmbedded" \in collectionTags
    /\ "toc.hhc" \in archive
    /\ "Binary TOC is not implemented" \in warnings
