---- MODULE UC017_Hhp_PreSectionLinesIgnored ----
EXTENDS Integers

(*
Scenario: lines before first section are ignored
...
ExpectedMetadata == {"Hhp:PreSectionIgnored", "Output:project/help.chm", "Title:Project Title"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Hhp:PreSectionIgnored" \in metadata
