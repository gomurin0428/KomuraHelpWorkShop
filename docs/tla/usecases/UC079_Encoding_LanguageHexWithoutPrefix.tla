---- MODULE UC079_Encoding_LanguageHexWithoutPrefix ----
EXTENDS Integers

(*
Scenario: Language LCID can be parsed without the 0x prefix
Implementation slices reflected: CliOptions.Parse, HhpProject.Load, TextEncodingDetector.Read, TextEncodingDetector.ForLcid, ProjectCompiler.BuildMetadata, ChmWriter.Write
...
ExpectedCollectionTags == {"HexLanguageWithoutPrefix", "LanguageParsed"}
ExpectedArchive == {"toc.hhc"}
ExpectedMetadata == {"DBCS:true", "LCID:0x0411-no-prefix", "Output:project/help.chm", "TextEncoding:CP932"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "HexLanguageWithoutPrefix" \in collectionTags
    /\ "LCID:0x0411-no-prefix" \in metadata
