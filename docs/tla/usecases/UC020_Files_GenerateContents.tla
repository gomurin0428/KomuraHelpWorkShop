---- MODULE UC020_Files_GenerateContents ----
EXTENDS Integers

(*
Scenario: missing contents file generates simple TOC
...
ExpectedCollectionTags == {"GeneratedContents"}
ExpectedArchive == {"Table of Contents.hhc", "index.html", "topics/usage.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "GeneratedContents" \in collectionTags
    /\ "Table of Contents.hhc" \in archive
