---- MODULE UC090_Paths_ProjectEntityLiteral ----
EXTENDS Integers

(*
Scenario: project paths keep HTML entities literal
...
ExpectedCollectionTags == {"ExplicitFiles", "ProjectEntityLiteral"}
ExpectedArchive == {"docs/a&amp;b.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "ProjectEntityLiteral" \in collectionTags
    /\ "docs/a&amp;b.html" \in archive
