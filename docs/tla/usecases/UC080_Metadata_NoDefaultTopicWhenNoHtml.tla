...
(*
Scenario: projects with no HTML file omit the default topic and generated TOC
...
ExpectedCollectionTags == {"NoDefaultTopic", "NoGeneratedContents"}
ExpectedArchive == {"readme.txt"}
