---- MODULE UC080_Metadata_NoDefaultTopicWhenNoHtml ----
EXTENDS Integers

(*
Scenario: projects with no HTML file omit the default topic
...
ExpectedCollectionTags == {"GeneratedContents", "NoDefaultTopic"}
ExpectedArchive == {"Table of Contents.hhc", "readme.txt"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "NoDefaultTopic" \in collectionTags
