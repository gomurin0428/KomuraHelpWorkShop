---- MODULE UC053_Chm_SmallPmglOnly ----
EXTENDS Integers

(*
Scenario: small project uses PMGL without PMGI
...
ExpectedWriterTags == {"InternalStreams", "NoPMGI", "PMGL", "Uncompressed"}
