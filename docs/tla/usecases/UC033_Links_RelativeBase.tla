---- MODULE UC033_Links_RelativeBase ----
EXTENDS Integers

(*
Scenario: relative links are resolved from source directory
...
ExpectedCollectionTags == {"LinkScan", "RelativeBase"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "RelativeBase" \in collectionTags
