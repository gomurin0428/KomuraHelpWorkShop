---- MODULE UC093_Links_DecodedNulRejected ----
EXTENDS Integers

(*
Scenario: decoded NUL links are rejected before path resolution
...
ExpectedCollectionTags == {"DecodedNulRejected", "LinkScan"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "DecodedNulRejected" \in collectionTags
    /\ archive = {"index.html"}
    /\ warnings = {}
