---- MODULE UC062_Error_DirectoryEntryTooLarge ----
EXTENDS Integers

(*
Scenario: single directory entry too large fails
...
ExpectedWriterTags == {"DirectoryEntryTooLarge", "WriteFailed"}
ExpectedStdout == {}
ExpectedStderr == {"Directory entry is too large"}
ExpectedWarnings == {}
ExpectedExit == 1
