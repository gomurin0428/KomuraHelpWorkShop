---- MODULE UC056_Unsupported_FullTextSearch ----
EXTENDS Integers

(*
Scenario: full text search warns and disables index
...
ExpectedMetadata == {"FullTextSearch:false", "Output:project/help.chm"}
ExpectedWriterTags == {"InternalStreams", "PMGL", "Uncompressed"}
ExpectedStdout == {"Banner", "Compiled", "Files"}
ExpectedStderr == {}
ExpectedWarnings == {"Full-text search index generation is not implemented"}
ExpectedExit == 0
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "FullTextSearch:false" \in metadata
    /\ "Full-text search index generation is not implemented" \in warnings
