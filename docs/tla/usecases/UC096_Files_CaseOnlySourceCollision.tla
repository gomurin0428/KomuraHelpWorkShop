---- MODULE UC096_Files_CaseOnlySourceCollision ----
EXTENDS Integers

(*
Scenario: case-only source archive collisions are quiet and keep the active source
...
ExpectedCollectionTags == {"CaseOnlySourceCollision", "DuplicateConflict"}
ExpectedArchive == {"topic.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "CaseOnlySourceCollision" \in collectionTags
    /\ warnings = {}
    /\ "topic.html" \in archive
