---- MODULE UC060_Unsupported_WindowsSection ----
EXTENDS Integers

(*
Scenario: WINDOWS section warns and generated default is used
...
ExpectedCollectionTags == {"UnsupportedWarning"}
ExpectedArchive == {"index.html"}
ExpectedMetadata == {"Output:project/help.chm", "Windows:generated-default"}
ExpectedWriterTags == {"InternalStreams", "PMGL", "Uncompressed", "Windows"}
ExpectedStdout == {"Banner", "Compiled", "Files"}
ExpectedStderr == {}
ExpectedWarnings == {"WINDOWS custom settings are not parsed"}
ExpectedExit == 0
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Windows:generated-default" \in metadata
    /\ "Windows" \in writerTags
    /\ "WINDOWS custom settings are not parsed" \in warnings
