---- MODULE UC046_Encoding_CurrentCultureFallback ----
EXTENDS Integers

(*
Scenario: invalid or omitted Language uses current culture
...
ExpectedCollectionTags == {"AnsiFallback"}
ExpectedArchive == {"index.html"}
ExpectedMetadata == {"LCID:CurrentCulture", "Output:project/help.chm", "TextEncoding:AnsiFallback"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "AnsiFallback" \in collectionTags
    /\ "LCID:CurrentCulture" \in metadata
