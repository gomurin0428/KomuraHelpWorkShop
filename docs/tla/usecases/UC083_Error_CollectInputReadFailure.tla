---- MODULE UC083_Error_CollectInputReadFailure ----
EXTENDS Integers

(*
Scenario: input text read failure during collection aborts compilation
Implementation slices reflected: CliOptions.Parse, HhpProject.Load, ProjectCompiler.CollectFiles, Program.Main
...
ExpectedCollectionTags == {"CollectFailed", "CollectInputReadError"}
ExpectedArchive == {}
ExpectedMetadata == {}
ExpectedWriterTags == {"Skipped"}
ExpectedStdout == {}
ExpectedStderr == {"error", "input file read error"}
ExpectedWarnings == {}
ExpectedExit == 1
ExpectedChmCreated == FALSE
ExpectedVisited == {"CliParsed", "Done", "FilesCollected", "ProjectLoaded", "Start"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "CollectFailed" \in collectionTags
    /\ "CollectInputReadError" \in collectionTags
    /\ exitCode = 1
    /\ chmCreated = FALSE
