---- MODULE UC089_Files_OmittedContentsNoReservedToc ----
EXTENDS Integers

(*
Scenario: omitted contents does not synthesize a reserved-name TOC
...
ExpectedCollectionTags == {"NoGeneratedContents"}
ExpectedArchive == {"C#Guide.html", "literal%23.html"}
ExpectedMetadata == {"DefaultTopic:C#Guide.html", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "NoGeneratedContents" \in collectionTags
    /\ "C#Guide.html" \in archive
    /\ "literal%23.html" \in archive
