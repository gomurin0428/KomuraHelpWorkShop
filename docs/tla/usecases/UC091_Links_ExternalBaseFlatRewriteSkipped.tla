---- MODULE UC091_Links_ExternalBaseFlatRewriteSkipped ----
EXTENDS Integers

(*
Scenario: flat rewrite leaves references under external base href unchanged
...
ExpectedCollectionTags == {"ExternalBasePreserved", "Flat", "FlatRewrite"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "ExternalBasePreserved" \in collectionTags
    /\ archive = {"index.html"}
