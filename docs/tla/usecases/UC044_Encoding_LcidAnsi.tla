---- MODULE UC044_Encoding_LcidAnsi ----
EXTENDS Integers

(*
Scenario: Language LCID selects ANSI code page
...
ExpectedCollectionTags == {"LanguageParsed"}
ExpectedArchive == {"toc.hhc"}
ExpectedMetadata == {"DBCS:true", "LCID:0x0411", "Output:project/help.chm", "TextEncoding:CP932"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    ...
    /\ "TextEncoding:CP932" \in metadata
