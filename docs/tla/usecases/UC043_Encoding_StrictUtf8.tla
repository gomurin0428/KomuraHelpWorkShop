---- MODULE UC043_Encoding_StrictUtf8 ----
EXTENDS Integers

(*
Scenario: BOM-less valid UTF-8 is read as UTF-8
...
ExpectedCollectionTags == {"Utf8Strict"}
ExpectedArchive == {"index.html"}
ExpectedMetadata == {"Encoding:UTF8", "Output:project/help.chm"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Utf8Strict" \in collectionTags
    /\ "Encoding:UTF8" \in metadata
