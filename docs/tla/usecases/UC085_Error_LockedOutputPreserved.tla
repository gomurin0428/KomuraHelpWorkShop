---- MODULE UC085_Error_LockedOutputPreserved ----
EXTENDS Integers

(*
Scenario: locked existing output fails without overwriting it
Implementation slices reflected: CliOptions.Parse, HhpProject.Load, ProjectCompiler.CollectFiles, ProjectCompiler.BuildMetadata, ChmWriter.Write, Program.Main
...
ExpectedMetadata == {"ExistingOutput:Preserved", "Output:project/help.chm", "Title:Project Title"}
ExpectedWriterTags == {"ExistingOutputPreserved", "OutputCreateLocked", "WriteFailed"}
ExpectedStdout == {}
ExpectedStderr == {"error", "output file locked"}
ExpectedWarnings == {}
ExpectedExit == 1
ExpectedChmCreated == FALSE
...
AllCollectionTags == {"AbsoluteProjectFile", "AllowMissing", "AnsiFallback", "ArchiveBaseDirectory", "BomDetected", "CleanQueryFragment", "CollectFailed", "CollectInputReadError", "CssLinks", "DeclaredLanguageEncoding", "DecodeHtmlPercent", "DefaultTopicFirstHtml", "DotPathIgnored", "DuplicateConflict", "DuplicateSameFile", "EmptyLinkIgnored", "ExplicitFiles", "ExternalLinksIgnored", "Flat", "FlatArchive", "FlatRewrite", "GeneratedContents", "GeneratedContentsEscaped", "HexLanguageWithoutPrefix", "HtmlLinks", "InvalidUtf8Fallback", "LanguageParsed", "LinkReadFailed", "LinkScan", "LocalParamLinks", "MalformedPercentKept", "MissingRequired", "NoDefaultTopic", "NoLinkScan", "NonScannable", "NormalizeArchivePath", "NormalizeDots", "OptionalMissing", "OutsideProjectFile", "RelativeBase", "RequiredFiles", "RootRelative", "Skipped", "SourceIndexEmbedded", "SourceTocEmbedded", "TruthyOption", "UncLinkIgnored", "UnsupportedWarning", "Utf8Strict", "VerboseLog"}
AllArchivePaths == {"Table of Contents.hhc", "asset.bin", "bad%ZZ.html", "bg.png", "downloads/manual.pdf", "help.css", "images/bg.png", "images/logo.png", "index.hhk", "index.html", "logo.png", "readme.txt", "shared/page.html", "site.css", "styles/site.css", "styles/theme.css", "toc.hhc", "topic-&-one.html", "topics/a b.html", "topics/intro.html", "topics/reference.html", "topics/start.html", "topics/usage.html", "usage.html"}
AllMetadataTags == {"Contents:Table of Contents.hhc", "Contents:toc.hhc", "ContentsGenerated:true", "DBCS:true", "DefaultTopic:index.html", "DefaultTopic:topics/start.html", "Encoding:BOM", "Encoding:InvalidUtf8Fallback", "Encoding:UTF8", "ExistingOutput:Preserved", "Font:MS UI Gothic, 9", "FullTextSearch:false", "GeneratedContentsEscaped:true", "Hhp:BlankOptionIgnored", "Hhp:CaseInsensitive", "Hhp:CommentsIgnored", "Hhp:LastOptionWins", "Hhp:PreSectionIgnored", "Hhp:QuotedValues", "Hhp:UnbalancedQuoteLiteral", "Index:index.hhk", "KeptSource:a/index.html", "LCID:0x0411", "LCID:0x0411-no-prefix", "LCID:CurrentCulture", "LinksRewrittenForFlat:true", "MergeFiles:metadata-only", "Output:absolute/output.chm", "Output:project/created/out.chm", "Output:project/dist/output.chm", "Output:project/final.chm", "Output:project/help.chm", "Output:project/manual.chm", "OutputDirectoryCreated:true", "StringTable:Deduplicated", "TextEncoding:AnsiFallback", "TextEncoding:CP932", "TextEncoding:CurrentAnsi", "Title:'Open", "Title:New Title", "Title:Oversized", "Title:Product Help", "Title:Project Title", "Title:Quoted Title", "Title:manual", "Window:custom", "Window:main", "Windows:generated-default"}
AllWriterTags == {"DirectoryEntryTooLarge", "DirectoryTooLarge", "ExistingOutputPreserved", "InputReadError", "InternalStreams", "Itbits", "MetadataEntryTooLarge", "NameList", "NoPMGI", "OutputCreateLocked", "OutputWriteError", "PMGI", "PMGL", "Skipped", "StringTableDeduplicated", "Strings", "System", "Uncompressed", "Windows", "WriteFailed"}
AllStdout == {"Banner", "Compiled", "Files", "Options", "Usage", "Version"}
AllStderr == {"#SYSTEM entry is too large", "--out requires a path", "Directory entry is too large", "Missing required files", "Project file not found", "add log", "directory is too large for this compiler version", "error", "input file read error", "missing .hhp project path", "only one .hhp project", "output file locked", "unknown option"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "OutputCreateLocked" \in writerTags
    /\ "ExistingOutputPreserved" \in writerTags
    /\ "ExistingOutput:Preserved" \in metadata
    /\ chmCreated = FALSE
