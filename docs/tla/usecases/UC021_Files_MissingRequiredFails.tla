---- MODULE UC021_Files_MissingRequiredFails ----
EXTENDS Integers

(*
Scenario: missing required file fails by default
...
ExpectedCollectionTags == {"CollectFailed", "MissingRequired"}
ExpectedArchive == {}
ExpectedMetadata == {"Output:project/help.chm", "Title:Project Title"}
ExpectedWriterTags == {"Skipped"}
ExpectedStdout == {}
ExpectedStderr == {"Missing required files"}
ExpectedWarnings == {"file not found"}
ExpectedExit == 1
