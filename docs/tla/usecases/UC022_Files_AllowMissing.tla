---- MODULE UC022_Files_AllowMissing ----
EXTENDS Integers

(*
Scenario: allow-missing turns required absence into warning
...
ExpectedCollectionTags == {"AllowMissing", "MissingRequired"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "AllowMissing" \in collectionTags
