---- MODULE UC029_Links_NoLinkScan ----
EXTENDS Integers

(*
Scenario: no-link-scan keeps only explicit files
...
ExpectedCollectionTags == {"ExplicitFiles", "NoLinkScan"}
