---- MODULE UC073_Files_OutsideRelativeProjectPath ----
EXTENDS Integers

(*
Scenario: relative project file outside the project stores the file name
...
ExpectedCollectionTags == {"OutsideProjectFile"}
ExpectedArchive == {"page.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "OutsideProjectFile" \in collectionTags
    /\ archive = {"page.html"}
