---- MODULE UC045_Encoding_DeclaredLanguageRead ----
EXTENDS Integers

(*
Scenario: Language is used for initial HHP read
...
ExpectedCollectionTags == {"DeclaredLanguageEncoding"}
ExpectedArchive == {"index.html"}
ExpectedMetadata == {"LCID:0x0411", "Output:project/help.chm", "TextEncoding:CP932"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "DeclaredLanguageEncoding" \in collectionTags
    /\ "LCID:0x0411" \in metadata
