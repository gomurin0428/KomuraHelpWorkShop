---- MODULE UC069_Hhp_UnbalancedQuoteLiteral ----
EXTENDS Integers

(*
Scenario: unbalanced quoted option value is kept literally
...
ExpectedMetadata == {"Hhp:UnbalancedQuoteLiteral", "Output:project/help.chm", "Title:'Open"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Title:'Open" \in metadata
    /\ "Hhp:UnbalancedQuoteLiteral" \in metadata
