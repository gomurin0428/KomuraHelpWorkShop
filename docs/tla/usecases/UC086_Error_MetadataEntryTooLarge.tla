---- MODULE UC086_Error_MetadataEntryTooLarge ----
EXTENDS Integers

(*
Scenario: oversized metadata entry fails before CHM creation
...
ExpectedMetadata == {"Output:project/help.chm", "Title:Oversized"}
ExpectedWriterTags == {"MetadataEntryTooLarge", "WriteFailed"}
ExpectedStdout == {}
ExpectedStderr == {"#SYSTEM entry is too large", "error"}
ExpectedWarnings == {}
ExpectedExit == 1
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "MetadataEntryTooLarge" \in writerTags
    /\ "#SYSTEM entry is too large" \in stderr
    /\ chmCreated = FALSE
