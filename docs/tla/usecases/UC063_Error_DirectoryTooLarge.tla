---- MODULE UC063_Error_DirectoryTooLarge ----
EXTENDS Integers

(*
Scenario: directory too large for compiler version fails
...
ExpectedWriterTags == {"DirectoryTooLarge", "WriteFailed"}
ExpectedStdout == {}
ExpectedStderr == {"directory is too large for this compiler version"}
ExpectedWarnings == {}
ExpectedExit == 1
