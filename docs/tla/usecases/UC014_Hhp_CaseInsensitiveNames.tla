---- MODULE UC014_Hhp_CaseInsensitiveNames ----
EXTENDS Integers

(*
Scenario: section and option names are case-insensitive
...
ExpectedMetadata == {"Hhp:CaseInsensitive", "Output:project/help.chm", "Title:Project Title"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "Hhp:CaseInsensitive" \in metadata
