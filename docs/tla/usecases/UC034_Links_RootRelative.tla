---- MODULE UC034_Links_RootRelative ----
EXTENDS Integers

(*
Scenario: root-relative links are resolved from project directory
...
ExpectedCollectionTags == {"LinkScan", "RootRelative"}
ExpectedArchive == {"images/logo.png", "topics/intro.html"}
...
UseCaseSpecificContract ==
  phase = "Done" =>
    /\ "RootRelative" \in collectionTags
    /\ "images/logo.png" \in archive
