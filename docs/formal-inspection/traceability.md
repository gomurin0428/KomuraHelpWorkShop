...
| E-005 | `E-005` | UC023/UC024/UC096 use-case models | map silent last-wins invariant | `FlatDuplicateConflictKeepsLast`, `OutsideProjectBasenameCollisionsKeepLast`, `CaseOnlyArchiveSourceCollisionIsQuiet` | covered for flat, outside-basename, and case-only conflicts. |
...
| B-003 | flat archive behavior | UC040/UC041/UC097 | flat archive and payload-preservation postcondition | `FlatDuplicateConflictKeepsLast`, `FlatBaseHrefScannerFlattensArchiveWithoutRewritingPayload`, `FlatUtf16RewritePreservesBom`, `FlatLinkRewriteSeedPropertiesAreStable` | covered for archive flattening, payload preservation, and helper rewrite idempotence. |
